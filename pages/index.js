      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form>
          <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
            ...
            <button type="button" className={`btn btn-primary btn-floating mx-1 ${styles.socialMediaLogin}`} title="Google">
              <i class="fab fa-google"></i>
            </button>

            <button type="button" className={`btn btn-primary btn-floating mx-1 ${styles.socialMediaLogin}`} title="Discord">
              <i class="fab fa-discord"></i>
            </button>

            <button type="button" className={`btn btn-primary btn-floating mx-1 ${styles.socialMediaLogin}`} title="GitHub">
